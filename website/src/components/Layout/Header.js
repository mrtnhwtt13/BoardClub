        ...
        const authLinks = isAuthenticated && (
            ...
            <Toolbar className={classes.space}>
                ...
                <Grid container spacing={3}>
                    ...
                    <Button disableElevation variant="contained" size="large" className={classes.btn} style={{ backgroundColor: "#FE65DC", color: "white", width: "10rem", height: "4rem"}} component={Link} to="/scheduledGames" >
                        Scheduled Games
                    </Button>
                    </Grid>
                    <Grid container justify="center" item xs={12} sm={4}>
